...
public class MemVO {
	...
	public int getMem_enabled() {
		return mem_enabled;
	}
	public void setMem_enabled(int mem_enabled) {
	...
	public String toString() {
		return "MemVO [mem_id=" + mem_id + ", mem_pass=" + mem_pass + ", mem_name=" + mem_name + ", mem_bir=" + mem_bir
				+ ", mem_addr=" + mem_addr + ", mem_zipcode=" + mem_zipcode + ", mem_rank=" + mem_rank + ", mem_hp="
				+ mem_hp + ", mem_mail=" + mem_mail + ", mem_enabled=" + mem_enabled + ", mem_img=" + mem_img
				+ ", mem_regdate=" + mem_regdate + ", mem_enddate=" + mem_enddate + "]";
	}
